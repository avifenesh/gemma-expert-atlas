# Combined Early-Then-Silent Plus Never-Active Static-Mask Full Eval

Baseline: `data/personal_agent_bank/runs/20260620T170017Z/results.json`
Variant: `data/surgery_experiments/combined_static_eval/full_retry2/20260620T192556Z/results.json`

## Summary

- balanced_reasoning_off: score 0.7596 -> 0.7452 (-0.0144), decode 142.55 -> 143.36 tok/s
- balanced_reasoning_on: score 0.7436 -> 0.7468 (+0.0032), decode 144.52 -> 145.07 tok/s

## Category Deltas

| Config | Category | Base | Variant | Delta | +/- tasks |
|---|---|---:|---:|---:|---:|
| balanced_reasoning_off | agent_orchestration | 0.917 | 0.917 | +0.000 | +0 / -0 |
| balanced_reasoning_off | code_review | 0.625 | 0.667 | +0.042 | +1 / -0 |
| balanced_reasoning_off | coding_agent | 0.833 | 0.958 | +0.125 | +3 / -0 |
| balanced_reasoning_off | eval_design | 0.875 | 0.708 | -0.167 | +1 / -5 |
| balanced_reasoning_off | expert_surgery | 0.792 | 0.750 | -0.042 | +1 / -2 |
| balanced_reasoning_off | instruction_following | 0.458 | 0.375 | -0.083 | +2 / -3 |
| balanced_reasoning_off | local_system_ops | 0.958 | 0.958 | +0.000 | +0 / -0 |
| balanced_reasoning_off | model_ops | 0.917 | 0.833 | -0.083 | +0 / -2 |
| balanced_reasoning_off | personal_research | 0.625 | 0.562 | -0.062 | +0 / -2 |
| balanced_reasoning_off | personalization_memory | 0.708 | 0.708 | -0.000 | +1 / -1 |
| balanced_reasoning_off | routine_monitoring | 0.667 | 0.750 | +0.083 | +2 / -0 |
| balanced_reasoning_off | social_support | 0.542 | 0.500 | -0.042 | +1 / -2 |
| balanced_reasoning_off | tool_recovery | 0.958 | 1.000 | +0.042 | +1 / -0 |
| balanced_reasoning_on | agent_orchestration | 0.958 | 0.917 | -0.042 | +0 / -1 |
| balanced_reasoning_on | code_review | 0.625 | 0.583 | -0.042 | +1 / -2 |
...
| balanced_reasoning_on | instruction_following | 0.333 | 0.458 | +0.125 | +4 / -1 |
| balanced_reasoning_on | local_system_ops | 0.958 | 0.958 | +0.000 | +0 / -0 |
| balanced_reasoning_on | model_ops | 0.875 | 0.833 | -0.042 | +1 / -2 |
| balanced_reasoning_on | personal_research | 0.625 | 0.625 | +0.000 | +2 / -3 |
| balanced_reasoning_on | personalization_memory | 0.625 | 0.542 | -0.083 | +1 / -3 |
| balanced_reasoning_on | routine_monitoring | 0.708 | 0.750 | +0.042 | +1 / -0 |
| balanced_reasoning_on | social_support | 0.542 | 0.625 | +0.083 | +1 / -0 |
...
| balanced_reasoning_off | eval_design_001 | eval_design | 1.000 | 0.667 | -0.333 |
...
| balanced_reasoning_off | expert_surgery_002 | expert_surgery | 1.000 | 0.667 | -0.333 |
...
| balanced_reasoning_off | instruction_following_005 | instruction_following | 0.667 | 0.333 | -0.333 |
...
| balanced_reasoning_on | agent_orchestration_008 | agent_orchestration | 1.000 | 0.667 | -0.333 |
...
| balanced_reasoning_on | model_ops_002 | model_ops | 1.000 | 0.667 | -0.333 |
...
| balanced_reasoning_on | personal_research_007 | personal_research | 0.250 | 0.750 | +0.500 |
| balanced_reasoning_on | coding_agent_006 | coding_agent | 0.667 | 1.000 | +0.333 |
...
| balanced_reasoning_on | instruction_following_004 | instruction_following | 0.333 | 0.667 | +0.333 |
| balanced_reasoning_on | instruction_following_007 | instruction_following | 0.333 | 0.667 | +0.333 |
| balanced_reasoning_on | model_ops_006 | model_ops | 0.333 | 0.667 | +0.333 |
| balanced_reasoning_on | personalization_memory_008 | personalization_memory | 0.333 | 0.667 | +0.333 |
| balanced_reasoning_on | personal_research_008 | personal_research | 0.500 | 0.750 | +0.250 |
